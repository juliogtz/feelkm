$(function() {
 var STATUS_MENU_TOP_USER=0;
    ...
    $('#btn-register-facebook-3').hover(function() {
        ...
        $(this).attr('src', '/statics/imgs/btn-login-hover-facebook.png');

    }, function() {

      $(this).attr('src', '/statics/imgs/btn-login-facebook.png');
    });
    ...
    /* Click login btn normal */
      ...
      $('#btn-login-normal-img').hover(function() {
        ...
        $(this).attr('src', '/statics/imgs/btn-login-hover.png');

    }, function() {

      $(this).attr('src', '/statics/imgs/btn-login.png');
    ...
    $('#btn-register-facebook').hover(function() {
      ...
      $(this).attr('src', '/statics/imgs/btn-register-facebook-hover.png');

    }, function() {

      $(this).attr('src', '/statics/imgs/btn-register-facebook.png');
    });
    ...
    $( "#btn-register-facebook" ).click(function() {
         ...
         $(this).attr('src', '/statics/imgs/btn-register-facebook-on.png');
   ...
   $( "#sub-title-register-link" ).click(function() {
    ...
    /* Click on register box - btn link register with normal  */
      ...
      $(this).attr('src', '/statics/imgs/btn-register-hover.png');

    }, function() {

      $(this).attr('src', '/statics/imgs/btn-register.png');
    });
...
function getCookie(name) {
 ...
 $( "#btn-register-normal-img" ).click(function() {
      ...
      $("#box-register-form-wait").fadeIn( "fast");
         ...
         //$(this).attr('src', '/statics/imgs/btn-register-on.png');
     ...
     $( "#btn-login-normal-img" ).click(function() {
         ...
         //$(this).attr('src', '/statics/imgs/btn-login-on.png');
...
function feedback(){
 ...
 function csrfSafeMethod(method) {
    ...
    if($("#input-feedback").val() !="") {
        ...
        alert("No se permite enviar mensaje en blanco.");
