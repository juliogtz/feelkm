        ...
        if request.method == 'POST':
            ...
            if(str(email_exist)=="[]"):
                ...
                try:
                    ...
                    usr_rec = users.objects.get(id_user_admin = usr_recovery )
